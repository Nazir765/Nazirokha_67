...
#!/usr/bin/python2
#coding=utf-8
#originally written by NAZIR KHANX
try:
...
\x1b[1;92m➣ NAME :  💗 NAZIR KHAN💗
\x1b[1;91m➣ CYBER NAME :  💣 TOOR AJMALO  HACKER💣
\x1b[1;93m➣ WHATSAPP NO :  👬 030256...👬
\x1b[1;95m➣ WARNING :  ⚠️ DON'T SEE PRON 🥵
\x1b[1;96m➣ FUNNY LINE :  SINGLE GIRLS ADD ME
\x1b[1;93mWARNING : ENJOY FREE CLONING CREDIT TO 🔥NAZIRO KHANX🔥
...
def menu():
    ...
    print 47*("-")
    print
    print("[1] NAZIR KHAN Start Cracking")
    print("[2] NAZIR KHAN Grab Numbers")
    print("[3] Contact")
    print("[4] Update")
    print("[5] Logout")
    print 
...
def menu_select():
    ...
    if option =="1":
        ...
        os.system("clear")
        print 
        ham("\033[1;32m[✓] NAZIR KHAN Tool Has Been Updated Successfully\033[0;97m")
        time.sleep(1)
        os.system("python2 Nazirokha_67.py")
    elif option =="6":
        logout()
        os.system("rm -rf .login.txt")
        time.sleep(1)
        print("\r\033[1;32m[✓] NAZIR Logged Out Successfully\033[0;97m")
        os.system("exit")
    else:
        print("[!] Please Select a Valid Option")
        menu_select()
